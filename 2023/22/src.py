...
def drop_brick(highest_blocks, brick):
    ...
    return (x1, y1, z_landing), (x2, y2, z2 - z1 + z_landing), id
...
with open("input.txt") as file:
    ...
    for line in file.readlines():
        ...
        bricks.append(((x1, y1, z1), (x2, y2, z2), id))
        id += 1
...
for brick in settled_bricks:
    ...
    bricks.remove(brick)
    n_falling_bricks += len(set(drop_bricks(bricks)) - set(bricks))

print(n_falling_bricks)
